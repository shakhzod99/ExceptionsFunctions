 ...
 * Вывести полное имя самого старшего человека, у которого длина
 * этого имени не превышает 15 символов.
 */
public class Task5 {
  public static void main(String[] args) {
    List<Person> persons = List.of(
        ...
        new Person("John", "Johns", 25),
        new Person("Michael", "Jackson", 18),
        new Person("TommyLi", "Thompson", 56)
    );
    persons.stream()
